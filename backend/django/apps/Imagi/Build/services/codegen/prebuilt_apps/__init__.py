...
The public pages — home, about and contact — all belong to the 'home' app and
are scaffolded with it (see home.py). They used to be one app each, which read
oddly in the workspace's page menu ('about' folder, one page in it) for no
gain: they share a header, a footer and the navigation between them.
