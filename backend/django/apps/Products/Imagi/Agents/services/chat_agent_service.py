...
class ChatAgentService(BaseAgentService):
    ...
    def get_system_prompt(self, project_name=None):
        ...
        return {
            "role": "system",
            "content": (
                f"You are an expert web designer and developer called Imagi, a powerful ai platform for building web applications. "
    ...
    def process_conversation(self, user_input, model, user, **kwargs):
        ...
        try:
            ...
            try:
                from apps.Products.Imagi.Agents.models import AgentMessage
