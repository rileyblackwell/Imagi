"""
Base agent service module for Imagi.
...
def build_conversation_history(conversation, project_path=None, current_file=None, current_user_prompt=None):
    ...
    if not project_name:
        project_info += "Project Name: Imagi Web Application\n"
        project_info += "Project Description: A web application built with Imagi, an AI-powered web application generator that enables users to build full-stack web applications using natural language.\n"
    
    # Always add platform information for context
    project_info += "\nPlatform: Imagi - AI-powered web application generator\n"
    ...
    def build_conversation_history(self, conversation, project_path=None, current_file=None, is_build_mode=False, current_user_prompt=None):
        ...
        if not has_project_info:
            ...
            project_info = {
                ...
                "content": (
                    "PROJECT INFORMATION:\n"
                    "Project Name: Imagi Web Application\n"
                    "Project Description: A web application built with Imagi, an AI-powered web application generator.\n"
                    "\nPlatform: Imagi - AI-powered web application generator\n"
