    ...
    <div class="max-w-7xl mx-auto relative">
      ...
      <div class="text-center mb-16 md:mb-20">
        ...
        <div class="inline-flex items-center gap-2 px-4 py-2 bg-white/[0.03] rounded-full border border-white/[0.08] mb-6">
          <i class="fas fa-heart text-xs text-rose-400/80"></i>
          <span class="text-sm font-medium text-white/60">Success Stories</span>
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
        ...
        >
          <!-- Card -->
          <div class="relative h-full p-7 md:p-8 rounded-2xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-sm hover:bg-white/[0.04] hover:border-white/[0.1] transition-all duration-500 cursor-default overflow-hidden flex flex-col">
            <!-- Hover glow -->
            <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
              <div class="absolute inset-0 bg-gradient-to-br opacity-[0.03]" :class="getGradientClass(testimonial.color)"></div>
            </div>
            ...
            <div class="relative flex gap-1 mb-5">
              <i 
                ...
                :class="n <= testimonial.rating ? getStarClass(testimonial.color) : 'text-white/10'"
              ></i>
            </div>
            
            <!-- Testimonial text -->
            <p class="relative text-white/70 text-base leading-relaxed mb-8 flex-1">
              {{ testimonial.text }}
            </p>
            
            <!-- Divider -->
            <div class="relative w-full h-px bg-gradient-to-r from-transparent via-white/[0.08] to-transparent mb-6"></div>
            ...
            <div class="relative flex items-center gap-4">
              ...
              <!-- Name and position -->
              <div>
                <h4 class="font-semibold text-white/90 text-sm">{{ testimonial.author }}</h4>
...
export default defineComponent({
  ...
  props: {
    ...
    subtitle: {
      type: String,
      default: 'See how non-technical users are building web apps in minutes for a fraction of traditional costs.'
    },
    testimonials: {
      type: Array,
      default: () => [
        {
          ...
          text: 'I was quoted $4,500 by a web developer. With Imagi, I built my business app myself for under $10 in just one afternoon — no coding needed!',
          rating: 5,
          color: 'violet'
        },
        {
          ...
          text: 'I love the pay-per-request model. I created my entire professional web app for $8 in AI credits. The different AI models are great for different tasks.',
          rating: 5,
          color: 'fuchsia'
        },
        {
          ...
          text: 'Being able to chat with the AI to build my web app was amazing! I just described what I wanted, and it created everything for me. Saved me thousands!',
          rating: 5,
          color: 'blue'
        }
      ]
