        ...
        <template v-if="verifyResult.phone_numbers.length">
          ...
          <div class="flex flex-wrap gap-2">
            <button
              ...
              type="button"
              class="px-3 py-1.5 rounded-full border border-emerald-300/70 dark:border-emerald-400/30 bg-white/70 dark:bg-white/[0.06] font-mono text-xs hover:bg-white dark:hover:bg-white/[0.12] transition-colors duration-150 focus-ring"
