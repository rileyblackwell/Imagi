<!--
  ...
  Route: /products/imagi/project/:projectName/operations
-->
<template>
...
import { matchesSlug } from '@/apps/products/imagi/utils/slug'
import type { Project } from '@/apps/products/imagi/types/components'
