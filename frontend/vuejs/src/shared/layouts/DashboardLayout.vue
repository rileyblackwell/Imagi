  ...
  <BaseLayout>
    <div class="min-h-screen flex">
      ...
      <aside 
        ...
        :class="[
          isSidebarCollapsed ? 'w-16 bg-white dark:bg-[#0a0a0a]' : (wide ? 'w-80 bg-white dark:bg-dark-950/95 backdrop-blur-md' : 'w-72 bg-white dark:bg-dark-950/95 backdrop-blur-md')
        ]"
      >
        <!-- Logo and Brand -->
      ...
      <div 
        ...
        :class="[isSidebarCollapsed ? 'ml-16' : (wide ? 'ml-80' : 'ml-72')]"
      >
        <!-- Navbar -->
        <BaseNavbar 
          ...
          :class="[isSidebarCollapsed ? 'left-16' : (wide ? 'left-80' : 'left-72')]"
        >
          <template #left>
            <!-- Navbar left section -->
          </template>
