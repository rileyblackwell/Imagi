...
<template>
  <svg
    ...
    focusable="false"
  >
    <!-- Design Visually — pen / vector tool -->
    <template v-if="name === 'design'">
    ...
    <!-- Launch to the Web — rocket -->
    <template v-else-if="name === 'launch'">
    ...
    <!-- Marketing — megaphone -->
    <template v-else-if="name === 'marketing'">
      <path d="m3 11 18-5v12L3 14v-3z" />
      <path d="M11.6 16.8a3 3 0 1 1-5.8-1.6" />
    </template>

    <!-- Sales — handshake / closing the deal -->
    ...
    <!-- Founders — sprout / new growth -->
    <template v-else-if="name === 'founders'">
      <path d="M7 20h10" />
